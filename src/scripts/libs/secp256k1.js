...
function Secp256k1() {
    if (typeof module !== 'undefined') {
        ...
        randomBytes = length => (typeof window === "undefined" ? crypto : window.crypto).getRandomValues(new Uint8Array(length))
        const tmpGlobal = typeof window === "undefined" ? this.self : window;
        tmpGlobal.Secp256k1 = exports = {}
    }
